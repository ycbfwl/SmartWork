...
public class Mail {
	...
	public static String myEmailAccount = Utils.getPropertie("emailsender");
	public static String myEmailPassword = Utils.getPropertie("emailsenderpasswd");

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易126邮箱的 SMTP 服务器地址为: smtp.126.com
	public static String myEmailSMTPHost = Utils.getPropertie("emailsmtp");

	// 收件人邮箱（替换为自己知道的有效邮箱）
	// public static String receiveMailAccount = "ycbfwl@aliyun.com";

	public void sendMail(String receiver, String subject, String mailDody) throws Exception {
		...
		// 3. 创建一封邮件
		MimeMessage message = createMimeMessage(session, myEmailAccount, receiver, subject, mailDody);
	...
	public MimeMessage createMimeMessage(Session session, String sender, String receiveMail, String subject,
			String mailBody) throws Exception {
		// 1. 创建一封邮件
		MimeMessage message = new MimeMessage(session);

		// 2. From: 发件人
		message.setFrom(new InternetAddress(sender, null, "UTF-8"));
